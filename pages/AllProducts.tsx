          ...
          {products.filter(p => activeTab === 'All' || p.category === activeTab).map(product => (
            ...
            >
              <div className="group cursor-pointer relative">
                <div onClick={() => navigate(`/product/${product.id}`)} className="bg-zinc-50/30 rounded-3xl mb-4 overflow-hidden relative border border-zinc-100 shadow-sm group-hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2 group-hover:border-emerald-500/20 aspect-[4/5] flex items-center justify-center">
